...
/* Symbol names are autogenerated by ld, based on the filename. */
extern const char _binary_build_m0_core1_o_bin_start[];
extern const unsigned long _binary_build_m0_core1_o_bin_size;
...
int main(void)
{
  ...
  SYSCON->CPBOOT = (unsigned long)(_binary_build_m0_core1_o_bin_start)|1; /* set Thumb bit */
